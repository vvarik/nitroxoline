...
significantly changed fitness (sometimes, it is too crowded for all names
though).

One could speculate that the stronger effect of a drug, as for nitro2 vs nitro
1 was beneficial to elucidate the phenotype.
